...
class CorrelationCoefficient{
    CorrelationCoefficient(){
        ...
        System.out.println("\n\n\nso the table is:\n\n\n");
        System.out.println("\t\t\t\t\t\tX\t\tY\t\tx=X-"+Math.round(obj.Sum1(a,s))+"\t\ty=Y-"+Math.round(obj.Sum1(b,s))+"\t\tx^2\t\ty^2\t\txy");
        for (int i = 0; i < s; i++) {
        ...
        System.out.println("\t\t\t\t\t\t\t\t∑X="+ obj.Sum1(a, s)+"\t\t∑Y=\t" + obj.Sum1(b,s)+"∑x=\t"+obj.Sum1(c,s)+"\t∑y="+obj.Sum1(d,s)+"\t∑x^2="+obj.Sum1(e,s)+"∑y^2="+obj.Sum1(f,s)+"\t∑xy="+obj.Sum1(g,s));
        System.out.println("\n\nthe all sum in the table is:\n");
        System.out.println("\t∑X="+ obj.Sum1(a, s)+"\n∑Y=\t" + obj.Sum1(b,s)+"\n∑x=\t"+obj.Sum1(c,s)+"\n∑y="+obj.Sum1(d,s)+"\n∑x^2="+obj.Sum1(e,s)+"\n∑y^2="+obj.Sum1(f,s)+"\n∑xy="+obj.Sum1(g,s));
        System.out.println("Standard deviation for x is:\t"+Math.sqrt((obj.Sum1(e,s)/s)-(Math.pow(obj.Sum1(c,s)/s,2))));
        System.out.println("Standard deviation for y is:\t"+Math.sqrt((obj.Sum1(f,s)/s)-(Math.pow(obj.Sum1(d,s)/s,2))));
...
class FittingGeometricCurve {
      FittingGeometricCurve() {
          ...
          System.out.println("\t\t\t\t∑x=" + obj.Sum1(a, s) + "\t∑y=" + obj.Sum1(b, s) + "\t∑X=" + obj.Sum1(d, s) + "\t∑Y=" + obj.Sum1(c, s) + "\t∑X^2=" + obj.Sum1(e, s) + "\tXY=" + obj.Sum1(f, s));
          ...
          double[][] g = {{s, obj.Sum1(d, s)},
                  {obj.Sum1(d, s), obj.Sum1(e, s)}
          };
     ...
     class FittingStraightLine {
           FittingStraightLine() {
            ...
            System.out.println("\t\t\t∑x=" + obj.Sum1(a, s) + "\t∑y=" + obj.Sum1(b, s) + "\t∑X^2=" + obj.Sum1(c, s) + "\t∑Y=" + obj.Sum1(d, s));
            System.out.println("\n\nsum of x is ∑x=\t" + obj.Sum1(a,s));
            System.out.println("\n\nsum of y is ∑y=\t" + obj.Sum1(b,s));
            System.out.println("\n\nsum of X^2 is ∑X^2=\t" + obj.Sum1(c,s));
            System.out.println("\n\nsum of Y=log y is ∑XY=\t" + obj.Sum1(d,s));
               double[][] g = {{s, obj.Sum1(a,s)},
                       {obj.Sum1(a,s), obj.Sum1(c,s)}
               };
               double cc = (g[0][0] * g[1][1]) - (g[0][1] * g[1][0]);
               double cc1 = 1 / cc;
               double[][] h = {{(g[1][1] * cc1), (-g[0][1] * cc1)}, {(-g[1][0] * cc1), (g[0][0] * cc1)}};
     ...
     class FittingParaBola {
           FittingParaBola() {
            ...
            System.out.println("\t\t\t\t∑x=" + obj.Sum1(a, s) + "\t∑y=" + obj.Sum1(b, s) + "\t∑X^2=" + obj.Sum1(c, s) + "\t∑X^3=" + obj.Sum1(d, s) + "\t∑X^4=" + obj.Sum1(e, s) + "\t∑X*Y=\t" + obj.Sum1(f, s) + "\t∑X*Y=" + obj.Sum1(f, s));
            System.out.println("\n\nsum of x is ∑x=\t" + obj.Sum1(a, s));
            System.out.println("\n\nsum of y is ∑y=\t" + obj.Sum1(b, s));
            ...
            double[][] i = {{s, obj.Sum1(a, s), obj.Sum1(c, s)},
                    {obj.Sum1(a, s), obj.Sum1(c, s), obj.Sum1(d, s)},
            ...
            double[][] k = {{s, obj.Sum1(b, s), obj.Sum1(c, s)},
                    {obj.Sum1(a, s), obj.Sum1(f, s), obj.Sum1(d, s)},
                    {obj.Sum1(c, s), obj.Sum1(g, s), obj.Sum1(e, s)}};
            double o = ((k[0][0]) * ((k[1][1] * k[2][2]) - (k[1][2] * k[2][1]))
                    - ((k[0][1]) * ((k[1][0] * k[2][2]) - (k[1][2] * k[2][0])))
                    + ((k[0][2]) * ((k[1][0] * k[2][1]) - (k[1][1] * k[2][0]))));
            double[][] l = {{s, obj.Sum1(a, s), obj.Sum1(b, s)},
                    {obj.Sum1(a, s), obj.Sum1(c, s), obj.Sum1(f, s)},
     ...
     class FittingExponentialCurve {
           FittingExponentialCurve() {
            ...
            System.out.println("\t\t\t\t∑x=" + obj.Sum1(a, s) + "\t∑y=" + obj.Sum1(b, s) + "\t ∑Y=log y=" + obj.Sum1(c, s) + "\t∑(X)^2=" + obj.Sum1(d, s) + "\t∑X*log y=" + obj.Sum1(e, s));
            System.out.println("\n\nsum of x is ∑x=\t" + obj.Sum1(a, s));
            System.out.println("\n\nsum of y is ∑y=\t" + obj.Sum1(b, s));
    ...
    RegressionYx(){
        ...
        System.out.println("\n\n\t\t\there bxy=\t"+byx);
        System.out.println("\n\n\n\t\t\tthe regression equation is:\n\t\t(y\t-\t"+obj.Sum1(b,s)/s+")\t=\t"+byx+"(x-"+obj.Sum1(a,s)/s+")");
    }
    }
    class RegressionXy{
    RegressionXy(){
        ...
        System.out.println("\n\n\t\t\there bxy=\t"+bxy);
        System.out.println("\n\n\n\t\t\tthe regression equation is:\n\t\t(x\t-\t"+obj.Sum1(a,s)/s+")\t=\t"+bxy+"(y-"+obj.Sum1(b,s)/s+")");
    }
    }
    class NormalRank{
    NormalRank(){
        ...
        for (int i = 0; i < s; i++) {
            System.out.println(" in column no." + (i + 1) + "\t" + a[i] + "\t\t" + b[i] + "\t\t" + d[i] + "\t\t" + c[i] + "\n\n");
        }
        System.out.println("___________________________________________________________________________________________________________________________________________");
        System.out.println("\t\t\t\t\t\t\t\t∑X="+ obj.Sum1(a, s)+"\t\t∑Y=\t" + obj.Sum1(b,s)+"∑d=\t"+obj.Sum1(d,s)+"\t∑d^2="+obj.Sum1(c,s));
...
public class MathAllinOne {
        public static void main(String[] args) {
            Scanner sc = new Scanner(System.in);
            System.out.println(" 1.For Mean Deviation Calculator Press : 1(one)\n2.For Standard Deviation Calculation press : 2(two)");
            ...
            if (s1 == 1) {
                ...
                RegressionXy onj=new RegressionXy();
            }
            else {
